...
const OPENAI_API_KEY = "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"; // Your OpenAI API key here
...
const handleImageGeneration = (e) => {
  ...
  const imgCardMarkup = Array.from({ length: userImgQuantity }, () => 
      `<div class="img-card loading">
        <img src="/static/css/images/loader.svg" alt="AI generated image">
        <a class="download-btn" href="#">
          <img src="/static/css/images/download.svg" alt="download icon">
        </a>
      </div>`
  ).join("");
